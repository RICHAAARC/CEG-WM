...
execution revision `3b7fed49e2f13900dbcef86fe2de2aab7dc7551c` and fresh run
`ceg_wm_salient_local_lf_mask_write_worker_bootstrap_diagnosis`. It runs exactly two operational
