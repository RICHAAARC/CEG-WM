"""Uncalibrated, research-only rotation search prototype. Not a production detector.
...
from cegwm.runtime.blind_detection import _raw_h, _geometry_disposition
...
def search(image: Image.Image, score_current_rgb: Callable,
    ...
    return {"status":"UNCALIBRATED_SEARCH_PROTOTYPE","science_denominator":0,
