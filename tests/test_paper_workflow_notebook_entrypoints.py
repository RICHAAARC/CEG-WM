...
def test_paper_workflow_notebook_entrypoints_bind_expected_scripts() -> None:
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in pw00_constants
    assert 'PROMPT_FILE = "prompts/paper_pilot_10.txt"' in pw00_constants
    assert 'PW_BASE_CONFIG_PATH = "paper_workflow/configs/pw_base_geometry_interval_discovery_v2.yaml"' in pw00_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in pw01_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in pw02_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in pw03_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in pw05_constants
...
def test_pw04_notebook_first_code_cells_expose_stage_specific_user_parameters() -> None:
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in prepare_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in quality_constants
    ...
    assert 'FAMILY_ID = "paper_eval_family_geometry_interval_discovery_v2"' in finalize_constants
...
def test_pw00_notebook_exposes_independent_attack_shard_count_controls() -> None:
    ...
    assert 'SOURCE_SHARD_COUNT = 3' in pw00_constants
    assert 'ATTACK_SHARD_COUNT = 3' in pw00_constants
    assert 'discovery v2 默认冻结为 3' in pw00_constants
...
def test_pw00_notebook_default_family_and_base_config_bind_discovery_v2() -> None:
    """
    Verify PW00 notebook defaults bind the discovery-v2 family and pw_base config.
    ...
    pw00_constants = _find_code_cell_source(
        NOTEBOOK_PW00_PATH,
        'PW_BASE_CONFIG_PATH = "paper_workflow/configs/pw_base_geometry_interval_discovery_v2.yaml"',
    )
