...
# Functional coverage for the content-adaptive engine.
...
from experiments import content_adaptive_engine as runner
...
_ADAPTIVE_PROTOCOL_DIGEST = "af4434590c12c882808279f331e1e987e2031719b9076c8d6ca2bd2d5f66d51f"
_FIXED_PUBLIC_KEY_DIGEST = "805bc21e173a" + "0" * 52
_OLD_RUN_ID = "content-adaptive-v2-bfd9b7464195-805bc21e173a"
_ADAPTIVE_RUN_ID = "content-adaptive-v2-af4434590c12-805bc21e173a"
...
def test_runtime_asset_contract_changes_run_identity_and_rejects_old_resume(
    ...
    assert identity["run_id"] != _ADAPTIVE_RUN_ID
