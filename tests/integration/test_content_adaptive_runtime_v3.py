...
from cegwm.runtime import content_adaptive_sd35_v3 as runtime
...
class _Pipeline:
    def __init__(self, assets: runtime.ContentV3EmbedAssets) -> None:
...
def _assets(*, official_size: bool = False) -> runtime.ContentV3EmbedAssets:
    ...
    return runtime.ContentV3EmbedAssets(
        _Dino(), BitImageProcessor(official_size=official_size), hf, lf
    )


@pytest.mark.integration
def test_content_v3_runtime_executes_step18_baseline_64_probes_and_real_embedding() -> None:
    assets = _assets()
    output = runtime.run_sd35_content_v3(
        _Pipeline(assets),
        "Content V3 runtime fixture",
        b"registered-key-01",
        assets,
        height=512,
        width=512,
...
@pytest.mark.integration
def test_content_v3_runtime_passes_real_signal_allocation_to_v3_embed_only(
...
@pytest.mark.integration
def test_content_v3_runtime_reuses_public_builtin_and_sizedict_contract() -> None:
