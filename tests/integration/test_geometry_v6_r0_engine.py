...
def test_notebook_has_no_geometry_secret_and_fixed_handoff():
    ...
    for constant in ("APPROVED_EXACT='da2b08a29765372785032f70046efe9d870c77c9'", "R0_UNIT_ID='geometry-v6-r0-dev-0001'", "PROMPT='A watchmaker sorting steel springs beneath a magnifying lamp'", 'SEED=2026082400', 'HEIGHT=512', 'WIDTH=512'):
