...
# Unit coverage for the content-adaptive method.
...
@pytest.mark.unit
def test_adaptive_direct_semantic_gate_and_rgb8_texture_coordinate() -> None:
...
@pytest.mark.unit
def test_adaptive_counterfactual_neutrals_are_semantic_zero_texture_raw_zero_and_other_half() -> None:
...
@pytest.mark.unit
def test_adaptive_response_consistency_only_helps_own_branch_and_sensitivity_cannot_help() -> None:
...
@pytest.mark.unit
def test_adaptive_direct_gate_prevents_old_global_ratio_reversal() -> None:
...
@pytest.mark.unit
def test_adaptive_direct_gate_bounds_and_lf_hf_semantic_dominance() -> None:
...
def test_adaptive_64_actual_dtype_probes_are_noncumulative_baseline_differenced_and_invariant(
    dtype: torch.dtype,
) -> None:
...
@pytest.mark.unit
def test_adaptive_zero_response_modality_stays_zero_without_fallback() -> None:
...
@pytest.mark.unit
def test_adaptive_six_ordered_nonnegative_effects_one_budget_and_no_private_measurement() -> None:
