...
def build_pipeline_provenance(
    ...
    provenance = {
        ...
        "resolved_model_id": _resolve_optional_str(cfg.get("resolved_model_id")),
        ...
        "resolved_model_source": _resolve_optional_str(cfg.get("resolved_model_source")),
        "model_snapshot_path": _resolve_optional_str(cfg.get("model_snapshot_path")),
        "model_source_resolution": _resolve_optional_str(cfg.get("model_source_resolution")),
        "local_snapshot_status": _resolve_optional_str(cfg.get("local_snapshot_status")),
        "local_snapshot_error": _resolve_optional_str(cfg.get("local_snapshot_error")),
