...
def run_stage_03(
    *,
    ...
    write_json_atomic(workflow_summary_path, {
        ...
        "scalar_formal_scope": aggregate_report_obj.get("scalar_formal_scope", grid_summary_obj.get("scalar_formal_scope")),
        "scalar_formal_score_name": aggregate_report_obj.get("scalar_formal_score_name", grid_summary_obj.get("scalar_formal_score_name")),
