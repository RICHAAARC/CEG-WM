...
def _ensure_official_source(runtime_root: Path, method: str) -> Path:
    ...
    if head != spec["official_exact"] or dirty:
        print(json.dumps({"official_source_revision": head, "source_modified": bool(dirty), "note": "source differs from reference"}))
    return source
