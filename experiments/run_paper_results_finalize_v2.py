...
from experiments.run_paper_main_worker_v2 import CONFIG_PATH, METHOD_ID, REPO_ROOT


BASELINE_JOBS = {
    "t2smark": "paper-baseline-t2smark-v2",
    "tree_ring": "paper-baseline-treering-v2",
    "gaussian_shading": "paper-baseline-gaussian-shading-v2",
    "shallow_diffuse": "paper-baseline-shallow-diffuse-v2",
}
MAIN_JOB_ID = "paper-main-v2"
RECONSTRUCTION_JOB_ID = "paper-main-reconstruction-v2"
...
def run_finalize(
    *, drive_root: Path, expected_exact: str, baseline_exact: str,
    ...
    output_root = drive_root / "finalized" / "paper-formal-v2"
    ...
    if missing and not finalize_incomplete:
        state = publish_job_state(
            output_root,
            {
                "job_id": "paper-formal-v2-finalizer",
                "run_id": "paper-formal-v2-finalizer",
    ...
    payload = {
        "schema_version": "cegwm_unified_paper_result_package_v2",
