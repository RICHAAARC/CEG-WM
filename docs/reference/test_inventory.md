...
| --- | --- | --- | --- |
| `tests/unit/test_lf_routing_combination.py` | `unit` | yes | LF carrier/blind detector、S/T/R/Q routing、同 route/mask 绑定的 LF/HF embedder、同普通图像观测约束与未晋升 C0/C1/C2 组合诊断。 |
